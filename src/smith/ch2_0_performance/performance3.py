...
from smith.ch2_0_performance.ch2_0_performance import set_repro, reproducible_step, profile_train, profile_config1, profile_config2, train


class Perf3Transformer(nn.Module):
    ...
    for i in range(self.n_layers):
        with record_function("layer"):
            with record_function("QK"):
                # print(f"{x.stride=} {self.blocks[i].params.Q.stride=}")
